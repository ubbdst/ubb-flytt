    ...
    madeObject: ({ node }) =>
      h("figure", {}, [
        ...
        h("figcaption", {}, [
          ...
          h(
            "a",
            { href: "/id/" + node._id, target: "_target" },
            " (Åpne i nytt vindu)"
          )
        ])
      ]),
      ...
      h("div", { class: "media" }, [
        ...
        h(
          ...
          h(
            "div",
            { class: "content" },
            h("h1", {}, h("a", { href: "/id/" + node._id }, node.label.nor))
          )
        )
      ]),
    authorReference: ({ node }) =>
      h("b", {}, h("a", { href: "/id/" + node.author._id }, node.author.label)),
    instagramPost: ({ node }) =>
      h("b", {}, h("a", { href: node.url }, node.url)),
    code: ({ node }) =>
