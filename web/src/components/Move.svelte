<script>
  ...
  let titleForMove =
    "Flytt fra " + item.movedFrom.label.nor + " til " + item.movedTo.label.nor;
</script>
...
<nav class="breadcrumb is-centered is-small" aria-label="breadcrumbs">
  <ul>
    ...
    <li>
      <a href="/moves">Flytt</a>
    </li>
    <li class="is-active">
      <a href="#" aria-current="page">{titleForMove}</a>
    </li>
  </ul>
</nav>
      ...
      <div class="columns">
        <div class="column has-text-centered">
          {#if item.movedFrom}
            ...
            <ul>
              <li>
                <a href="/places/{item.movedFrom._id}">
                  {item.movedFrom.label.nor}
                </a>
              </li>
            </ul>
          {/if}
        ...
        <div class="column has-text-centered">
          {#if item.movedTo}
            ...
            <ul>
              <li>
                <a href="/places/{item.movedTo._id}">
                  {item.movedTo.label.nor}
                </a>
              </li>
            </ul>
          {/if}
      ...
      <div class="columns">
        <div class="column has-text-centered is-full is-marginless box">
          ...
          {#if item.moved && item.moved.length > 0}
            <MediaObjects objects={item.moved} />
          {/if}
        </div>
      </div>
    </div>
